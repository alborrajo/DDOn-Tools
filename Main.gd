...
func _load_stage_markers(stage_no, subgroup_id):
	...
	if String(stage_no) in DataProvider.gathering_spots:
		for gathering_spot in DataProvider.gathering_spots[String(stage_no)]:
			...
			assert(gathering_spot_placemark.connect("mouse_entered", ui_node, "_on_gathering_spot_placemark_mouse_entered", [gathering_spot_placemark]) == OK)
			assert(gathering_spot_placemark.connect("mouse_exited", ui_node, "_on_gathering_spot_placemark_mouse_exited", [gathering_spot_placemark]) == OK)
